...
function Router() { return <Switch><Route path="/login" component={LoginPage} /><Route path="/mentions-legales" component={LegalPage} /><Route path="/prestation/:id" component={ServiceDetail} /><Route component={HashRouter} /></Switch>; }
